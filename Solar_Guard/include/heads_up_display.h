...
public:
    ...
    bn::sprite_ptr spr_speed = bn::sprite_items::spr_hud_speed.create_sprite(-18,-71);
    bn::sprite_ptr spr_shield_tgt = bn::sprite_items::spr_hud_shield.create_sprite(79,-75);
    bn::sprite_ptr spr_hull_tgt = bn::sprite_items::spr_hud_hull.create_sprite(79,-67);
